...
export default function StoreProvider({
  ...
  return (
    <Provider store={storeRef.current}>
      {/* PersistGate delays the rendering of children until the persisted state has been retrieved and rehydrated */}
      <PersistGate loading={null} persistor={persistor}>
        {children} {/* Render child components once the state is rehydrated */}
      </PersistGate>
    </Provider>
  );
}
